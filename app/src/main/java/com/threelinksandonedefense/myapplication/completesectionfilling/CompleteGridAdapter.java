...
public class CompleteGridAdapter extends BaseAdapter {
    ...
    public CompleteGridAdapter(Context context,
                ...
                vh.pictureImg.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (minePopupWindow == null) {
                            minePopupWindow = new MinePopupWindow((CompleteSectionFillingActivity) context, itemOnClick);
                        }
                        minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                        Utils.hideInputWindow((CompleteSectionFillingActivity)context);
                    }
                });
            }
        } else {
