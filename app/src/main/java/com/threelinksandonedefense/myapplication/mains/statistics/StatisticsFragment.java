package com.threelinksandonedefense.myapplication.mains.statistics;
...
public class StatisticsFragment extends MVPBaseFragment<StatisticsContract.View, StatisticsPresenter> implements StatisticsContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fra_statistics, null);
    ...
    private void initview() {
        ...
        mWebview.loadUrl("http://106.37.229.146:7109/Demonstration/DomeIndex.html");
    }
