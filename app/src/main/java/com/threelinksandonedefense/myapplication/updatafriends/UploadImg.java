...
public class UploadImg {
    ...
    private ArrayList<UpVideoBean> listDataLocal;
    private UpVideoBean baseInfo;//当前正在上传的条目
    private int pro = 0;
     ...
     */
    public UploadImg(Activity context, ArrayList<UpVideoBean> listDataLocal) {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case MSG:
                        ...
                        break;
                    case UPLOAD_SUCCESS:
                        if(activity instanceof UpDataFriendsActivity){
                            ((UpDataFriendsActivity) activity).refreshDataMethod();
                        }
    ...
    private void saveDiseaseNetwork(UpVideoBean baseInfo) {
        if (baseInfo != null ) {
